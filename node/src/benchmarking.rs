...
use runtime::{AccountId, Balance, BalancesCall, RuntimeCall, SystemCall};
use sc_cli::Result;
use sc_client_api::BlockBackend;
use sp_core::{Encode, Pair};
use sp_inherents::{InherentData, InherentDataProvider};
use sp_keyring::Sr25519Keyring;
use sp_runtime::{generic, traits::SaturatedConversion, OpaqueExtrinsic};

use std::{sync::Arc, time::Duration};


type TxExtension = runtime::TxExtension;
...
pub fn create_benchmark_extrinsic(
	...
	let raw_payload = SignedPayload::new(call.clone(), tx_ext.clone())
